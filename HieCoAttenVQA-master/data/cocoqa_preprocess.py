...
def main():
    ...
    f = open('C:\\HieCoAttenVQA-master\\coco_qa\\train\\questions.txt', 'r')
    train_ques = []
    train_ques_id = []
    ques_id = 0
    for line in f:
    ...
    f = open('C:\\HieCoAttenVQA-master\\coco_qa\\train\\img_ids.txt', 'r')
    img_ids = []
    for line in f:
        if line[-1] == '\n':
            line = line[:-1]        
    ...
    f = open('C:\\HieCoAttenVQA-master\\coco_qa\\train\\answers.txt', 'r')
    answers = []
    for line in f:
        if line[-1] == '\n':
            line = line[:-1]        
    ...
    f = open('C:\\HieCoAttenVQA-master\\coco_qa\\train\\types.txt', 'r')
    types = []
    for line in f:
        if line[-1] == '\n':
            line = line[:-1]        
